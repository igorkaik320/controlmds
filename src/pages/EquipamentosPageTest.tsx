...
export default function EquipamentosPage() {
  ...
  // Usando localStorage temporariamente para teste
  const load = useCallback(async () => {
    try {
      console.log('Carregando equipamentos do localStorage...');
      const stored = localStorage.getItem('equipamentos');
      const storedSetores = localStorage.getItem('setores');
      const data = stored ? JSON.parse(stored) : [];
      const setoresData = storedSetores ? JSON.parse(storedSetores) : [
