...
import {
  ...
  fetchTransactions, saveTransactionToDB, updateTransactionInDB, deleteTransactionFromDB,
  recalculateAndSave, fetchVerifications, fetchProfiles,
  getSummary, getCurrentBalance, saveVerification, deleteVerificationFromDB,
  filterByDateRange,
...
export default function AdminPage() {
  ...
  }, [user, allVerifications, loadData]);
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-6 space-y-6">
        ...
        <div>
          ...
          <TransactionTable transactions={transactions} onEdit={handleEdit} onDelete={handleDelete} profileMap={profileMap} canEdit canDelete />
        </div>

        <div>
          <h2 className="text-lg font-semibold mb-3">Conferências de Caixa</h2>
          <VerificationTable verifications={verifications} profileMap={profileMap} onDelete={handleDeleteVerification} canDelete />
        </div>
      </main>
